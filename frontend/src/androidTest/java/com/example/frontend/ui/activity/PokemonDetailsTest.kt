...
class PokemonDetailsTest {
    ...
    fun pokemonDetailsTest() {
        ...
        val imageView = onView(
            allOf(
                withId(R.id.imageView), withContentDescription("Nome do pokemon"),
                withParent(
                    allOf(
        ...
        val textView = onView(
            allOf(
                withId(R.id.tv_pokemonNome), withText("Bulbasaur"),
                withParent(
                    allOf(
                        withId(R.id.InfoFragment),
                        withParent(withId(R.id.nav_fragment))
        ...
        val button = onView(
            allOf(
                withId(R.id.btn_addFavorite), withText("ADICIONAR"),
                withParent(
                    allOf(
                        withId(R.id.InfoFragment),
                        withParent(withId(R.id.nav_fragment))
        ...
        val textView2 = onView(
            allOf(
                withId(R.id.textView3), withText("Informa��es"),
                withParent(
                    allOf(
        ...
        textView2.check(matches(withText("Informa��es")))
        ...
        val textView4 = onView(
            allOf(
                withId(R.id.tv_peso), withText("6.9 kg"),
                withParent(withParent(withId(R.id.linearLayout))),
                isDisplayed()
            )
        )
        ...
        val textView6 = onView(
            allOf(
                withId(R.id.tv_altura), withText("0.71 m"),
                withParent(withParent(withId(R.id.linearLayout))),
                isDisplayed()
            )
        )
        ...
        val textView9 = onView(
            allOf(
                withId(R.id.tv_ovo), withText("2 km"),
                withParent(withParent(withId(R.id.linearLayout))),
                isDisplayed()
            )
        )
        ...
        val textView10 = onView(
            allOf(
                withId(R.id.btn_return), withText("Voltar"),
                withParent(
                    allOf(
                        withId(R.id.InfoFragment),
                        withParent(withId(R.id.nav_fragment))
