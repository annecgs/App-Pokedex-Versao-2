...
withParent(allOf(withId(R.id.includeDate),
withParent(IsInstanceOf.instanceOf(android.view.ViewGroup::class.java)))),
isDisplayed()))
        textView.check(matches(withText("Pokedex")))
        
        val imageView = onView(
allOf(withId(R.id.imagePokemon),
withParent(withParent(withId(R.id.rv_home))),
isDisplayed()))
        imageView.check(matches(isDisplayed()))
        
        val textView2 = onView(
allOf(withId(R.id.nomePokemon), withText("Bulbasaur"),
...
allOf(withId(R.id.candyPokemon), withText("Bulbasaur Candy"),
withParent(allOf(withId(R.id.linearLayout3),
withParent(IsInstanceOf.instanceOf(android.view.ViewGroup::class.java)))),
isDisplayed()))
...
allOf(withId(R.id.candyCount), withText("Quantidade de Candy 25"),
withParent(allOf(withId(R.id.linearLayout3),
withParent(IsInstanceOf.instanceOf(android.view.ViewGroup::class.java)))),
isDisplayed()))
