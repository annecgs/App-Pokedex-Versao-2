...
public final class FragmentErrorBinding implements ViewBinding {
  ...
  private FragmentErrorBinding(@NonNull LinearLayout rootView, @NonNull Button btnTryAgain,
      @NonNull ImageView imageView2, @NonNull TextView mensagem) {
  ...
  public static FragmentErrorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.mensagem;
      TextView mensagem = ViewBindings.findChildViewById(rootView, id);
      if (mensagem == null) {
        break missingId;
      }

      return new FragmentErrorBinding((LinearLayout) rootView, btnTryAgain, imageView2, mensagem);
    }
